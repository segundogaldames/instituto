    ...
    if (isset($_GET['id'])) {
        ...
        if (isset($_POST['confirm']) && $_POST['confirm'] == 1) {
            ...
            if (!$rut) {
                ...
                $res = $mbd->prepare("UPDATE funcionarios SET rut = ?, nombre = ?, fecha_nacimiento = ?, email = ?, direccion = ?, rol_id = ?, comuna_id = ? WHERE id = ?");
                $res->bindParam(1, $rut);
                ...
                if ($row) {
                    $_SESSION['success'] = 'El funcionario se ha modificado correctamente';
            ...
            <?php if(!empty($funcionario)): ?>
                ...
                <form action="" method="POST">
                    <div class="mb-3">
                        ...
                        <input type="text" name="rut" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="<?php echo $funcionario['rut']; ?>">
                        <div id="emailHelp" class="form-text text-danger">Ingresa el rut que deseas modificar.</div>
                    </div>
                    <div class="mb-3">
                        <label for="nombre" class="form-label">Nombre<span class="text-danger">*</span></label>
                        <input type="text" name="nombre" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="<?php echo $funcionario['nombre']; ?>">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="rol" class="form-control" id="">
                            <option value="<?php echo $funcionario['rol_id']; ?>">
                                <?php echo $funcionario['rol'] ?>
                            </option>
